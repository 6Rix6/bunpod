...
class _TestHomePageState extends State<TestHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<PodcastFeedsCubit, ViewState<List<PodcastFeed>>>(
        builder: (context, state) => switch (state) {
          _ when state.dataOrNull != null => HomeScreenLoaded(
...
class HomeScreenLoaded extends StatefulWidget {
  const HomeScreenLoaded({super.key, required this.feeds});

  final List<PodcastFeed> feeds;

  @override
  State<HomeScreenLoaded> createState() => _HomeScreenLoadedState();
}

class _HomeScreenLoadedState extends State<HomeScreenLoaded>
  ...
  Future<void> _refresh() async {
    await context.read<PodcastFeedsCubit>().refresh(
      onError: (error) =>
