...
mixin _$Channel {
 ...
 String get name; String get host; int get color; String get image; String get description;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,host,color,image,description);

@override
String toString() {
  return 'Channel(name: $name, host: $host, color: $color, image: $image, description: $description)';
}
...
@useResult
$Res call({
 String name, String host, int color, String image, String description
});
...
/// Create a copy of Channel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? host = null,Object? color = null,Object? image = null,Object? description = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String host,  int color,  String image,  String description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Channel() when $default != null:
return $default(_that.name,_that.host,_that.color,_that.image,_that.description);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String host,  int color,  String image,  String description)  $default,) {final _that = this;
switch (_that) {
case _Channel():
return $default(_that.name,_that.host,_that.color,_that.image,_that.description);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String host,  int color,  String image,  String description)?  $default,) {final _that = this;
switch (_that) {
case _Channel() when $default != null:
return $default(_that.name,_that.host,_that.color,_that.image,_that.description);case _:
  return null;
...
class _Channel implements Channel {
  const _Channel({required this.name, required this.host, required this.color, required this.image, required this.description});
...
/// Create a copy of Channel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? host = null,Object? color = null,Object? image = null,Object? description = null,}) {
